...
urlpatterns = [
    ...
    path('api/verify-otp/', userauths_views.VerifyOTPView.as_view(), name='email-otp'),
    path('user/email-verify/', userauths_views.VerifyEmail.as_view(), name='email_verify'),
    ...
    path('featured/products/',store_views.FeaturedProductListView.as_view(),name='featured-products',),
    path('best-seller/products/',store_views.BestSellerListView.as_view(),name='best-seller-products',),
    path('new-arrivals/products/',store_views.NewArrivalListView.as_view(),name='new-arrival-products',),
    path('special-offers/products/',store_views.SpecialOfferListView.as_view(),name='special-offers-products',),
    path('contact/',store_views.ContactCreateView.as_view(),name='contact-us',),
    path('newsletter/',store_views.NewsletterCreateView.as_view(),name='newsletter',),
    ...
    path('cod-checkout/<order_oid>/', store_views.CashOnDeliveryView.as_view(), name='cod-checkout'),
