...
from store.models import CartOrderItem,Newsletter,Contact, CouponUsers, Notification, Product, Tag ,Category, Cart, DeliveryCouriers, CartOrder, Gallery, Brand, ProductFaq, Review,  Specification, Coupon, Color, Size, Address, Wishlist
...
class ProductAdmin(ImportExportModelAdmin):
    ...
    list_filter = ['is_featured', 'status', 'in_stock', 'type', 'vendor']
    list_editable = ['image', 'title', 'price', 'is_featured', 'status',  'shipping_amount', 'is_new_arrival','is_bestseller', 'special_offer']
    list_display = ['product_image', 'image', 'title',   'price', 'is_featured', 'shipping_amount', 'in_stock' ,'stock_qty', 'order_count', 'vendor' ,'status', 'is_featured', 'special_offer' ,'is_new_arrival','is_bestseller']
